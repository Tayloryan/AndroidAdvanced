package com.sickcat.common.hotfix;
...
import com.sickcat.common.util.ShareReflectUtil;
 ...
 * @date 2020/07/29 3:04 PM
 * @email xiaohu.yan@ucarinc.com
 * @tel 7778
 * @desc
 */

class NewClassLoaderInjector {
    ...
    private static final class DispatchClassLoader extends ClassLoader {
        ...
        protected Class<?> findClass(String name) throws ClassNotFoundException {
            ...
            if (name.startsWith("com.sickcat.patch.")) {
                return findClass(mOldClassLoader, name);
            }
